...
set _DeploySetParametersFile=%RootPath%SHIPR.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%SHIPR.zip" (
echo "%RootPath%SHIPR.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%SHIPR.deploy-readme.txt" (
...
start notepad "%RootPath%SHIPR.deploy-readme.txt"
)
echo =========================================================
goto :eof
