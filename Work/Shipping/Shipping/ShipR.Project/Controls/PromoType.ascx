...
<fieldset>
	...
	Promo Type*: <asp:DropDownList ID="uxType" runat="server" AutoPostBack="True" 
		onselectedindexchanged="uxType_SelectedIndexChanged"></asp:DropDownList>&nbsp;&nbsp;
		<asp:CheckBox ID="chkExactPromo" Checked=true runat="server" /> Exact Promo/Full Order
	    ...
	    <tr>
	        <td>
		        <div runat="server" id="divIncreasePercent" visible=false>
		            <table border=1 cellpadding=0>
		                <tr>
		                    <td> <asp:DropDownList ID="drpIncreaseBox"  runat="server" 
		                ...
		                <tr>
		                    ...
		                    <td><asp:TextBox ID="uxIncreaseWeightThreshold" MaxLength="7" runat="server"></asp:TextBox></td>
		                </tr>
		                <tr>
		                    <td>Threshold Dollar:*</td>
		                    <td><asp:TextBox ID="uxIncreaseDollarThreshold" MaxLength="7" runat="server"></asp:TextBox></td>
		                </tr>
		            </table>	
		        </div>
		    </td>
	...
	<asp:PlaceHolder ID="uxDiscountType" runat="server">
		<table border=1 cellpadding=0>
	        <tr>
	            <td>
		            Discount Type*:<asp:DropDownList ID="ddlDiscountType" runat="server" 
    ...
    <asp:PlaceHolder ID="uxDetails" runat="server" Visible="false">
	    ...
	    <tr>
			...
			<td>
			<input id='btnAddSku' type='button' value='Add'  style=" width:70" onclick="javascript:AddSkuToListBox();" />
			</td>
	    </tr>
	        <tr>
	        <td>
	        ...
	        <td valign='top'>
	         <input id='btnRemoveSku' type='button'  value='Remove' onclick="javascript:RemoveSkuFromListBox();"/>
	        </td>
		</tr>	
		</table>
	</asp:PlaceHolder>
	    ...
	    <table border=1 cellpadding=1>
		    ...
		    <tr>
		        <td style="font-size:x-small" colspan=3>
				    Tip:Hold down CTRL key to select/unselect  <br/> multiple manufacturers
			    </td>
		    </tr>
		</table>
		<br />
		...
		<tr>
			...
			<tr>
		        <td style="font-size:x-small">
				    Tip:Hold down CTRL key to select/unselect  <br/> multiple payment methods
				</td>
		    </tr>
		</table>
		<br />
